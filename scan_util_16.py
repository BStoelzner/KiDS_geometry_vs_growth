...
class chi2_interpolators():
    def __init__(self,scan_locations,transverse_fid,parallel_fid):
        ...
        scan = np.loadtxt(scan_locations)
        ...
        interpolators = RectBivariateSpline(at,ap,grid,kx=1,ky=1)
    ...
    def get_Dchi2_from_distances(self,transverse,parallel):
        """
        Arguments:
        ...
        Dchi2 = self.interpolators(at,ap)
